...
# ここに対応拡張子とローダーを登録するだけで取り込み対象を増やせます
SUPPORTED_EXTENSIONS = {
    ".pdf": PyMuPDFLoader,                               # PDF
    ".docx": Docx2txtLoader,                             # Word
    ".csv":  lambda p: CSVLoader(p, encoding="utf-8"),   # CSV（UTF-8）
    ".txt":  lambda p: TextLoader(p, encoding="utf-8"),  # ★ 追加：テキスト
}
...
# チャンク間のオーバーラップ
CHUNK_OVERLAP = 50
# ベクターストアから取得する関連ドキュメント数（問題1の修正：3 → 5）
RETRIEVER_TOP_K = 5
